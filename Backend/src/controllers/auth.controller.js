  ...
  try {
    ...
    switch (decodedToken.role) {
      ...
      case 'admin':
        ...
        break;
      default:
        return res.status(200).json(new ApiResponse(200, { isAuthenticated: false }, "Invalid user role"));
    }
    ...
    // If token is invalid/expired, return not authenticated (don't throw error)
    res.status(200).json(new ApiResponse(200, { isAuthenticated: false }, "Invalid or expired token"));
  }
});
